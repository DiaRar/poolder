...
export default async function DashboardLayout({
  ...
  return (
    <div className="grid sidebar-container h-full min-w-full">
      <ul className="menu pt-5 p-2 bg-base-100 gap-2">
        <li>
      ...
      <div className="grid grid-cols-6 grid-rows-[min-content] gap-12 p-5 bg-base-200 lg:p-10 ">
        {children}
      </div>
    </div>
  );
